...
twitch_miner = TwitchChannelPointsMiner(
    username="dratquestionablyblow",
    password="Deniskoto0711",           # If no password will be provided, the script will ask interactively
    ...
    logger_settings=LoggerSettings(
        ...
        discord=Discord(
            webhook_api="https://discord.com/api/webhooks/1282051856666984608/pROqSZ6jTcNvsDhNYyxn5jMEtkCsNSmQjjzaK4quSd0AUdR-bRmGTUoGUmODOsWM8Bl5",  # Discord Webhook URL
            events=[Events.STREAMER_ONLINE, Events.STREAMER_OFFLINE,
                    Events.BET_LOSE, Events.CHAT_MENTION],                                  # Only these events will be sent to the chat
        ),
        matrix=Matrix(
